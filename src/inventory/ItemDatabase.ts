...
export const ITEM_DATABASE: Record<string, ItemDefinition> = {
  ...
  [ItemType.EGG]: {
    ...
    icon: '🥚',
    color: '#fff9c4',
    description: 'Fresh egg from chicken. Good for cooking.',
    weight: 0.1,
    effects: { hunger: 20, health: 2 },
    tags: ['food', 'animal', 'farm', 'sellable', 'edible', 'cooking']
  },
  [ItemType.MILK]: {
    id: ItemType.MILK,
    name: 'Milk',
    ...
    icon: '🥛',
    color: '#ffffff',
    description: 'Fresh milk from cow. Nutritious.',
    weight: 0.5,
    effects: { hunger: 25, health: 5, stamina: 10 },
    tags: ['food', 'animal', 'farm', 'sellable', 'edible', 'cooking']
  },
  [ItemType.WOOL]: {
    id: ItemType.WOOL,
    ...
    icon: '🧶',
    color: '#e0e0e0',
    description: 'Soft wool from sheep. Used for crafting clothes.',
    weight: 0.3,
    tags: ['material', 'animal', 'farm', 'sellable', 'craftable']
  },
  [ItemType.HAY]: {
    id: ItemType.HAY,
    name: 'Hay',
    ...
    icon: '🌾',
    color: '#c5a880',
    description: 'Dried hay. Feed for cows and sheep.',
    weight: 0.4,
    tags: ['material', 'feed', 'farm', 'sellable', 'animal']
  },
  [ItemType.ANIMAL_FEED]: {
    id: ItemType.ANIMAL_FEED,
    name: 'Animal Feed',
    type: ItemType.ANIMAL_FEED,
    category: ItemCategory.MATERIAL,
    rarity: ItemRarity.COMMON,
    stackable: true,
    maxStack: 50,
    ...
    icon: '🥣',
    color: '#a1887f',
    description: 'Mixed animal feed. All animals love it.',
    weight: 0.3,
    tags: ['material', 'feed', 'farm', 'sellable', 'animal', 'craftable']
  },
  [ItemType.TRUFFLE]: {
    id: ItemType.TRUFFLE,
    name: 'Truffle',
    type: ItemType.TRUFFLE,
    category: ItemCategory.FOOD,
    rarity: ItemRarity.RARE,
    stackable: true,
    maxStack: 10,
    ...
    icon: '🍄',
    color: '#5d4037',
    description: 'Rare truffle found by pigs. Very valuable!',
    weight: 0.2,
    effects: { hunger: 15, health: 10 },
    tags: ['food', 'rare', 'animal', 'farm', 'sellable', 'treasure', 'cooking']
  },

  // Cooked foods - Phase 16.3 Cooking System
  [ItemType.FRIED_EGG]: {
    id: ItemType.FRIED_EGG,
    name: 'Fried Egg',
    type: ItemType.FRIED_EGG,
    category: ItemCategory.FOOD,
    rarity: ItemRarity.COMMON,
    stackable: true,
    maxStack: 20,
    ...
    icon: '🍳',
    color: '#ffeb3b',
    description: 'Simple fried egg. Quick breakfast.',
    weight: 0.15,
    effects: { hunger: 35, health: 5, stamina: 10 },
    tags: ['food', 'cooked', 'breakfast', 'sellable', 'edible', 'cooking']
  },
  [ItemType.OMELETTE]: {
    id: ItemType.OMELETTE,
    name: 'Omelette',
    type: ItemType.OMELETTE,
    category: ItemCategory.FOOD,
    rarity: ItemRarity.UNCOMMON,
    stackable: true,
    maxStack: 10,
    ...
    icon: '🥘',
    color: '#ffcc80',
    description: 'Fluffy omelette with milk and mushroom. Restores well.',
    weight: 0.3,
    effects: { hunger: 60, health: 15, stamina: 20 },
    tags: ['food', 'cooked', 'breakfast', 'sellable', 'edible', 'cooking']
  },
  [ItemType.CHEESE]: {
    id: ItemType.CHEESE,
    ...
    icon: '🧀',
    color: '#ffeb3b',
    description: 'Aged cheese from milk. Good for cooking.',
    weight: 0.4,
    effects: { hunger: 40, health: 8 },
    tags: ['food', 'cooked', 'dairy', 'sellable', 'edible', 'cooking']
  },
  [ItemType.CAKE]: {
    id: ItemType.CAKE,
    name: 'Cake',
    ...
    icon: '🍰',
    color: '#f48fb1',
    description: 'Delicious cake with berries. Festive dessert!',
    weight: 0.8,
    effects: { hunger: 80, health: 25, stamina: 30 },
    tags: ['food', 'cooked', 'dessert', 'sellable', 'edible', 'cooking', 'rare']
  },
  [ItemType.SOUP]: {
    id: ItemType.SOUP,
    name: 'Soup',
    ...
    icon: '🍲',
    color: '#8d6e63',
    description: 'Warm vegetable soup with herbs. Comforting meal.',
    weight: 0.5,
    effects: { hunger: 50, health: 12, stamina: 15 },
    tags: ['food', 'cooked', 'soup', 'sellable', 'edible', 'cooking']
  },
  [ItemType.STEW]: {
    id: ItemType.STEW,
    name: 'Stew',
    ...
    icon: '🍛',
    color: '#a1887f',
    description: 'Hearty stew with wheat and vegetables. Very filling.',
    weight: 0.6,
    effects: { hunger: 75, health: 20, stamina: 25 },
    tags: ['food', 'cooked', 'meal', 'sellable', 'edible', 'cooking']
  },
  [ItemType.PANCAKE]: {
    id: ItemType.PANCAKE,
    name: 'Pancake',
    type: ItemType.PANCAKE,
    category: ItemCategory.FOOD,
    rarity: ItemRarity.COMMON,
    stackable: true,
    maxStack: 15,
    ...
    icon: '🥞',
    color: '#d7ccc8',
    description: 'Fluffy pancakes with egg and milk. Perfect breakfast.',
    weight: 0.35,
    effects: { hunger: 55, health: 10, stamina: 20 },
    tags: ['food', 'cooked', 'breakfast', 'sellable', 'edible', 'cooking']
  },
  [ItemType.SALAD]: {
    id: ItemType.SALAD,
    ...
    icon: '🥗',
    color: '#8bc34a',
    description: 'Fresh salad with carrots, berries and herbs. Light and healthy.',
    weight: 0.25,
    effects: { hunger: 35, health: 15, stamina: 10 },
    tags: ['food', 'cooked', 'meal', 'sellable', 'edible', 'cooking', 'healthy']
  },
