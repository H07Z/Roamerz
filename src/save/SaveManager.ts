...
export class SaveManager {
  ...
  private ensureDefaults(saveFile: SaveFile): SaveFile {
    ...
    saveFile.world = {
      ...
      weather: (saveFile.world as any).weather ?? { current: 'sunny', intensity: 0, nextChange: 0, totalChanges: 0, version: 1 },
      economy: (saveFile.world as any).economy ?? { shopInventories: {}, prices: {}, transactionHistory: [], totalTransactions: 0, totalSpent: 0, totalEarned: 0, version: 1 },
